...
mouseJoint = MOAICpConstraint.newPivotJoint (testObject4.body, rope1.body, 0, 0, -25, 0)
mouseJoint:setMaxForce ( 5000 )
mouseJoint:setBiasCoef ( 0.15 )
SceneManager.i:getCpSpace():insertPrim ( mouseJoint )

mouseJoint2 = MOAICpConstraint.newPivotJoint (rope1.body, rope2.body, 25, 0, -25, 0)
mouseJoint2:setMaxForce ( 5000 )
mouseJoint2:setBiasCoef ( 0.15 )
SceneManager.i:getCpSpace():insertPrim ( mouseJoint2 )

mouseJoint3 = MOAICpConstraint.newPivotJoint (rope2.body, rope3.body, 25, 0, -25, 0)
